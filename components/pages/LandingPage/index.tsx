        ...
        <GradientDiv>
          <div className="content">
            ...
            <section id="about">
              <h2>Who am I?</h2>
              <p>
                Who am I? Well, I am a start-up guy who discovered how rewarding building web apps felt. Seeing a
                project go from mere a idea to a fully functional product never fails to put a smile on my face. I
                specialize in React and used a variety of tools alongside it such as NextJS and Typescript to get things
                done. I am team player at heart who loves the synergy of collaboration and would not be here without it.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                In order to make users feel like they were in the same room, we designed a special 3D voice chat system
                that allowed users to hear their friends voice as if they were sitting right next to them.
              </p>
              <div className="techUsedBox">
                <IconTypeScript subtle />
                <IconSCSS subtle />
            ...
            <section>
              ...
              <p>
                ...
                University of Technology Sydney and Australia Catholic University. We were also in talks with Mirvac and
                other Universities with getting them to adopt the system before the impact of Covid.
              </p>
              <div className="techUsedBox">
                <IconPhotoshop subtle />
                <IconIllustrator subtle />
